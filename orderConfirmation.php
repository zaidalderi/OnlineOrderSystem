        ...
        <div class="row">
            <div class="col-lg-9">
                ...
                <div class="content-body">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="45" height="45" fill="currentColor" class="bi bi-check-circle confirmed-icon" viewBox="0 0 16 16">
                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"/>
                        <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z"/>
                    </svg> Order #<?php echo $orderID?></h4>
                    <h5 class="fw-bold">Thank you <?php echo $rows['first_name']?></h5>
                    <br>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-4 border-start">
                        <?php
                            $query = "SELECT * FROM payment_details WHERE order_id = ?";
                            $stmt = $conn->prepare($query);
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <a class="btn btn-warning form-control  btn-block" href="index.php">Back to menu</a>
                            </div>
                            <div class="col">
                                <a class="btn btn-primary form-control btn-block viewOrderButton" href="singleorder.php?orderID=<?php echo $orderID?>">View Order</a>
                            </div>
                        </div>
                    </div>
                </div>
