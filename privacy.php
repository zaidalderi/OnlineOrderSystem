  ...
  <body class="d-flex flex-column min-vh-100">
    <header class="p-3 bg-dark text-white">
        ...
        <div class="text-center privacy-container">
            <h3 class="p-1">Privacy Policy</h3>
            <p>We know that you care how information about you is used and shared and we appreciate your trust in us to do that carefully and sensibly.</p>
        </div>
